  ...
  return (
    <main className="min-h-screen flex flex-col bg-gradient-custom">
      ...
      <div className="container mx-auto px-4 flex-grow">
        ...
        <h2 className="text-2xl font-semibold mt-12 mb-6 text-[var(--color-text)]">Categorías</h2>
        <Categories />
        ...
        <div className="mt-16 relative bg-cover bg-center py-24 rounded-lg overflow-hidden" style={{backgroundImage: "url('/candles-background.jpg')"}}>
          <div className="absolute inset-0 bg-black opacity-50"></div>
          <div className="relative z-10 text-center">
            <h2 className="text-4xl font-bold text-white mb-4">Cotiza tu Vela Aromática Personalizada</h2>
            <p className="text-xl text-white mb-8">Crea la atmósfera perfecta para cualquier ocasión con nuestras velas aromáticas personalizadas.</p>
            <Link href="https://wa.me/1234567890?text=Hola,%20me%20gustaría%20cotizar%20una%20vela%20aromática%20personalizada" target="_blank" rel="noopener noreferrer">
